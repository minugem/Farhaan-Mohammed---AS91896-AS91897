...
#Store the Data
def store_details ():
    global print_details, name, receipt, item, quantity, list_entries, total_names, name_display, receipt_display, item_display,  quantity_display
...
def print_details ():
    ...
    Label(main_window, text=(name_display)).grid(column=1,row=total_names+11)
    Label(main_window, text=(receipt_display)).grid(column=2,row=total_names+11)
    Label(main_window, text=(item_display)).grid(column=3,row=total_names+11)
    Label(main_window, text=(quantity_display)).grid(column=4,row=total_names+11)
